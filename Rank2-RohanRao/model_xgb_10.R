...
X_build <- X_train[seq(1,nrow(X_train)) %% 3 == 0]
X_train <- X_train[seq(1,nrow(X_train)) %% 3 != 0]
...
model_xgb <- xgb.train(params = params, xgtrain, nrounds = 200, nthread = -1)
